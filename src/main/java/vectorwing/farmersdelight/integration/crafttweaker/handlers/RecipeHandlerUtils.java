...
public class RecipeHandlerUtils {
    public static final IRecipeComponent<SoundEvent> SOUND_COMPONENT = IRecipeComponent.simple(
            Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "recipe_component/sound"), new TypeToken<>(){}, SoundEvent::equals);
    public static final IRecipeComponent<String> COOKING_TAB_COMPONENT = IRecipeComponent.simple(
            Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "recipe_component/cooking_tab"), new TypeToken<>(){}, String::equals);
    public static final IRecipeComponent<IIngredient> TOOL_COMPONENT = IRecipeComponent.composite(
            Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "recipe_component/cutting_board_tool"),
            new TypeToken<>() {},
    ...
    public static final IRecipeComponent<IItemStack> CONTAINER_COMPONENT = IRecipeComponent.simple(
            Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "recipe_component/cooking_pot_container"), new TypeToken<>(){},  RecipeComponentEqualityCheckers::areStacksEqual);
}