...
public class CraftingRecipes
{
	...
	public static void canvasSignDyeing(FDRecipeProvider output, ItemLike canvasSign, ItemLike hangingCanvasSign, TagKey<Item> dyeTag) {
		output.shapeless(RecipeCategory.DECORATIONS, canvasSign, 1)
				...
				.save(output);
		output.shapeless(RecipeCategory.DECORATIONS, hangingCanvasSign, 1)
	 ...
	 */
	private static void recipesVanillaAlternatives(FDRecipeProvider output) {
		output.shapeless(RecipeCategory.MISC, Items.PUMPKIN_SEEDS)
				...
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "pumpkin_seeds_from_slice").toString());
		output.shaped(RecipeCategory.DECORATIONS, Items.SCAFFOLDING, 6)
				.pattern("b#b")
				.pattern("b b")
				.pattern("b b")
				...
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "scaffolding_from_canvas").toString());
		output.shaped(RecipeCategory.TOOLS, Items.LEAD)
				.pattern("ss ")
				.pattern("ss ")
				.pattern("  s")
				.define('s', ModItems.STRAW.get())
				.unlockedBy("has_straw", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.STRAW.get()))
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "lead_from_straw").toString());
		output.shaped(RecipeCategory.DECORATIONS, Items.PAINTING)
				.pattern("sss")
				.pattern("scs")
				.pattern("sss")
				...
				.unlockedBy("has_canvas", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CANVAS.get()))
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "painting_from_canvas").toString());
		output.shaped(RecipeCategory.BUILDING_BLOCKS, Items.PUMPKIN)
				.pattern("##")
				.pattern("##")
				.define('#', ModItems.PUMPKIN_SLICE.get())
				.unlockedBy("has_pumpkin_slice", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.PUMPKIN_SLICE.get()))
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "pumpkin_from_slices").toString());
		output.shaped(RecipeCategory.FOOD, Items.CAKE)
				.pattern("mmm")
				.pattern("ses")
				.pattern("www")
				...
				.group("cake")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "cake_from_milk_bottle").toString());
		output.shapeless(RecipeCategory.FOOD, Items.CAKE)
				...
				.group("cake")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "cake_from_slices").toString());
		output.shapeless(RecipeCategory.MISC, Items.BOOK)
				.requires(Items.PAPER)
				.requires(Items.PAPER)
				.requires(Items.PAPER)
				.requires(ModItems.CANVAS.get())
				.unlockedBy("has_canvas", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CANVAS.get()))
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "book_from_canvas").toString());
		output.shapeless(RecipeCategory.MISC, Items.MILK_BUCKET)
				...
				.requires(ModItems.MILK_BOTTLE.get())
				.unlockedBy("has_milk_bottle", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.MILK_BOTTLE.get()))
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "milk_bucket_from_bottles").toString());
		output.shapeless(RecipeCategory.MISC, Items.PAPER)
				...
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "paper_from_tree_bark").toString());
		output.shapeless(RecipeCategory.BUILDING_BLOCKS, Items.PACKED_MUD, 2)
				.requires(ModItems.STRAW.get())
				.requires(Items.MUD)
				.requires(Items.MUD)
				.unlockedBy("has_straw", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.STRAW.get()))
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "packed_mud_from_straw").toString());
	}
	private static void recipesCanvasSigns(FDRecipeProvider output) {
		output.shaped(RecipeCategory.DECORATIONS, ModItems.CANVAS_SIGN.get(), 3)
				.pattern("w#w")
				.pattern("w#w")
				.pattern(" / ")
				...
				.unlockedBy("has_canvas", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CANVAS.get()))
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModItems.HANGING_CANVAS_SIGN.get(), 6)
				.pattern("X X")
				.pattern("w#w")
				.pattern("w#w")
				.define('X', ItemTags.CHAINS)
	...
	private static void recipesBlocks(FDRecipeProvider output) {
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.STOVE.get())
				.pattern("iii")
				.pattern("B B")
				.pattern("BCB")
				...
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.COOKING_POT.get())
				.pattern("bSb")
				.pattern("iWi")
				.pattern("iii")
				...
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.BASKET.get())
				.pattern("b b")
				.pattern("# #")
				.pattern("b#b")
				.define('b', Items.BAMBOO)
				...
				.unlockedBy("has_canvas", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CANVAS.get()))
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.CUTTING_BOARD.get())
				.pattern("/##")
				.pattern("/##")
				.define('/', Items.STICK)
				...
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.SKILLET.get())
				.pattern(" ##")
				.pattern(" ##")
				.pattern("/  ")
				.define('/', Items.BRICK)
				...
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.OAK_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.BIRCH_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.SPRUCE_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.JUNGLE_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.ACACIA_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.DARK_OAK_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.MANGROVE_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.CHERRY_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.BAMBOO_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.CRIMSON_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModBlocks.WARPED_CABINET.get())
				.pattern("___")
				.pattern("D D")
				.pattern("___")
				...
				.group("fd_cabinet")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModItems.ROPE.get(), 4)
				.pattern("s")
				.pattern("s")
				.define('s', ModItems.STRAW.get())
				.unlockedBy("has_straw", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.STRAW.get()))
				.group("fd_rope")
				.save(output);
		output.shaped(RecipeCategory.DECORATIONS, ModItems.SAFETY_NET.get(), 1)
				.pattern("rr")
				.pattern("rr")
				.define('r', ModItems.ROPE.get())
				.unlockedBy("has_rope", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ROPE.get()))
				.save(output);
		output.shapeless(RecipeCategory.DECORATIONS, ModItems.ROPE.get(), 4)
				...
				.group("fd_rope")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "rope_from_safety_net").toString());
		output.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.CABBAGE_CRATE.get(), 1)
				.pattern("###")
				.pattern("###")
				.pattern("###")
				...
				.save(output);
		output.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.TOMATO_CRATE.get(), 1)
				.pattern("###")
				.pattern("###")
				.pattern("###")
				...
				.save(output);
		output.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.ONION_CRATE.get(), 1)
				.pattern("###")
				.pattern("###")
				.pattern("###")
				...
				.save(output);
		output.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.RICE_BALE.get(), 1)
				.pattern("###")
				.pattern("###")
				.pattern("###")
				...
				.save(output);
		output.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.RICE_BAG.get(), 1)
				.pattern("###")
				.pattern("###")
				.pattern("###")
				...
				.save(output);
		output.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.STRAW_BALE.get(), 1)
				.pattern("###")
				.pattern("###")
				.pattern("###")
				...
				.unlockedBy("has_straw", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.STRAW.get()))
				.save(output);
		output.shapeless(RecipeCategory.DECORATIONS, ModItems.CANVAS_RUG.get(), 2)
				.requires(ModItems.CANVAS.get())
				.unlockedBy("has_canvas", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CANVAS.get()))
				.save(output);
		output.shapeless(RecipeCategory.MISC, ModItems.CANVAS.get(), 1)
				...
				.group("fd_canvas")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "canvas_from_canvas_rug").toString());
		output.shapeless(RecipeCategory.BUILDING_BLOCKS, ModItems.ORGANIC_COMPOST.get(), 1)
				.requires(Items.DIRT)
				...
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "organic_compost_from_rotten_flesh").toString());
		output.shapeless(RecipeCategory.BUILDING_BLOCKS, ModItems.ORGANIC_COMPOST.get(), 1)
				.requires(Items.DIRT)
				.requires(ModItems.STRAW.get())
				.requires(ModItems.STRAW.get())
				...
				.unlockedBy("has_straw", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.STRAW.get()))
				.group("fd_organic_compost")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "organic_compost_from_tree_bark").toString());
		output.shaped(RecipeCategory.BUILDING_BLOCKS, ModItems.TATAMI.get(), 2)
				.pattern("cs")
				.pattern("sc")
				.define('c', ModItems.CANVAS.get())
				.define('s', ModItems.STRAW.get())
				...
				.save(output);
		// BREAKING DOWN
		output.shapeless(RecipeCategory.DECORATIONS, ModItems.FULL_TATAMI_MAT.get(), 2)
				.requires(ModItems.TATAMI.get())
				.unlockedBy("has_canvas", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CANVAS.get()))
				.group("fd_full_tatami_mat")
				.save(output);
		output.shapeless(RecipeCategory.DECORATIONS, ModItems.HALF_TATAMI_MAT.get(), 2)
				.requires(ModItems.FULL_TATAMI_MAT.get())
				.unlockedBy("has_canvas", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CANVAS.get()))
				.save(output);
		// COMBINING BACK
		output.shapeless(RecipeCategory.DECORATIONS, ModItems.FULL_TATAMI_MAT.get(), 1)
				.requires(ModItems.HALF_TATAMI_MAT.get())
				.requires(ModItems.HALF_TATAMI_MAT.get())
				.unlockedBy("has_canvas", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CANVAS.get()))
				.group("fd_full_tatami_mat")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "full_tatami_mat_from_halves").toString());
		output.shapeless(RecipeCategory.BUILDING_BLOCKS, ModItems.TATAMI.get(), 1)
				.requires(ModItems.FULL_TATAMI_MAT.get())
				.requires(ModItems.FULL_TATAMI_MAT.get())
				.unlockedBy("has_canvas", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.CANVAS.get()))
				.group("fd_tatami")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "tatami_block_from_full").toString());
	}
	private static void recipesTools(FDRecipeProvider output) {
		output.shaped(RecipeCategory.COMBAT, ModItems.FLINT_KNIFE.get())
				.pattern("m")
				.pattern("s")
				...
				.unlockedBy("has_stick", InventoryChangeTrigger.TriggerInstance.hasItems(Items.STICK))
				.save(output);
		output.shaped(RecipeCategory.COMBAT, ModItems.IRON_KNIFE.get())
				.pattern("m")
				.pattern("s")
				...
				.unlockedBy("has_iron_ingot", InventoryChangeTrigger.TriggerInstance.hasItems(Items.IRON_INGOT))
				.save(output);
		output.shaped(RecipeCategory.COMBAT, ModItems.DIAMOND_KNIFE.get())
				.pattern("m")
				.pattern("s")
				...
				.save(output);
		output.shaped(RecipeCategory.COMBAT, ModItems.GOLDEN_KNIFE.get())
				.pattern("m")
				.pattern("s")
	...
	private static void recipesMaterials(FDRecipeProvider output) {
		output.shaped(RecipeCategory.MISC, ModItems.CANVAS.get())
				.pattern("##")
				.pattern("##")
				.define('#', ModItems.STRAW.get())
				.unlockedBy("has_straw", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.STRAW.get()))
				.group("fd_canvas")
				.save(output);
		output.shapeless(RecipeCategory.FOOD, Items.CARROT, 9)
				...
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "carrot_from_crate").toString());
		output.shapeless(RecipeCategory.FOOD, Items.POTATO, 9)
				...
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "potato_from_crate").toString());
		output.shapeless(RecipeCategory.FOOD, Items.BEETROOT, 9)
				...
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "beetroot_from_crate").toString());
		output.shapeless(RecipeCategory.FOOD, ModItems.CABBAGE.get(), 9)
				...
				.group("fd_cabbage")
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.TOMATO.get(), 9)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.ONION.get(), 9)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.RICE_PANICLE.get(), 9)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.RICE.get(), 9)
		...
		output.shapeless(RecipeCategory.MISC, ModItems.STRAW.get(), 9)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.RICE.get())
				.requires(ModItems.RICE_PANICLE.get())
				.unlockedBy("has_rice_panicle", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.RICE_PANICLE.get()))
				.group("fd_rice")
				.save(output);
	}
	private static void recipesFoodstuffs(FDRecipeProvider output) {
		output.shapeless(RecipeCategory.MISC, ModItems.TOMATO_SEEDS.get())
				.requires(Ingredient.of(ModItems.TOMATO.get(), ModItems.ROTTEN_TOMATO.get()))
				.unlockedBy("has_tomato", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.TOMATO.get()))
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.MILK_BOTTLE.get(), 4)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.MELON_JUICE.get(), 1)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.WHEAT_DOUGH.get(), 3)
				...
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "wheat_dough_from_egg").toString());
		output.shaped(RecipeCategory.FOOD, ModItems.PIE_CRUST.get(), 1)
				.pattern("wMw")
				.pattern(" w ")
				.define('w', Items.WHEAT)
				.define('M', Tags.Items.DRINKS_MILK)
		...
		output.shapeless(RecipeCategory.FOOD, ModItems.CABBAGE.get())
				...
				.group("fd_cabbage")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "cabbage_from_leaves").toString());
		output.shapeless(RecipeCategory.FOOD, ModItems.HORSE_FEED.get(), 1)
				...
				.save(output);
		output.shaped(RecipeCategory.FOOD, ModItems.MELON_POPSICLE.get(), 1)
				.pattern(" mm")
				.pattern("imm")
				.pattern("-i ")
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.FRUIT_SALAD.get(), 1)
				.requires(Items.APPLE)
				.requires(Items.MELON_SLICE)
				.requires(Items.MELON_SLICE)
	...
	private static void recipesFoodBlocks(FDRecipeProvider output) {
		output.shaped(RecipeCategory.FOOD, ModItems.APPLE_PIE.get(), 1)
				.pattern("###")
				.pattern("aaa")
				.pattern("xOx")
				.define('#', Items.WHEAT)
		...
		output.shaped(RecipeCategory.FOOD, ModItems.APPLE_PIE.get(), 1)
				...
				.group("fd_apple_pie")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "apple_pie_from_slices").toString());
		output.shaped(RecipeCategory.FOOD, ModItems.SWEET_BERRY_CHEESECAKE.get(), 1)
				.pattern("sss")
				.pattern("sss")
				.pattern("mOm")
		...
		output.shaped(RecipeCategory.FOOD, ModItems.SWEET_BERRY_CHEESECAKE.get(), 1)
				...
				.group("fd_sweet_berry_cheesecake")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "sweet_berry_cheesecake_from_slices").toString());
		output.shaped(RecipeCategory.FOOD, ModItems.CHOCOLATE_PIE.get(), 1)
				.pattern("ccc")
				.pattern("mmm")
				.pattern("xOx")
		...
		output.shaped(RecipeCategory.FOOD, ModItems.CHOCOLATE_PIE.get(), 1)
				...
				.group("fd_chocolate_pie")
				.save(output, Identifier.fromNamespaceAndPath(FarmersDelight.MODID, "chocolate_pie_from_slices").toString());
	}
	private static void recipesCraftedMeals(FDRecipeProvider output) {
		output.shapeless(RecipeCategory.FOOD, ModItems.MIXED_SALAD.get())
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.NETHER_SALAD.get())
				.requires(Items.CRIMSON_FUNGUS)
				.requires(Items.WARPED_FUNGUS)
				.requires(Items.BOWL)
				.unlockedBy("has_bowl", InventoryChangeTrigger.TriggerInstance.hasItems(Items.BOWL))
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.BARBECUE_STICK.get())
				.requires(CommonTags.CROPS_TOMATO)
				...
				.unlockedBy("has_onion", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ONION.get()))
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.EGG_SANDWICH.get())
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.CHICKEN_SANDWICH.get())
				.requires(Tags.Items.FOODS_BREAD)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.HAMBURGER.get())
				.requires(Tags.Items.FOODS_BREAD)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.BACON_SANDWICH.get())
				.requires(Tags.Items.FOODS_BREAD)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.MUTTON_WRAP.get())
				.requires(Tags.Items.FOODS_BREAD)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.STUFFED_POTATO.get())
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.SALMON_ROLL.get(), 2)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.COD_ROLL.get(), 2)
				...
				.save(output);
		output.shaped(RecipeCategory.FOOD, ModItems.KELP_ROLL.get(), 1)
				.pattern("RXR")
				.pattern("###")
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.GRILLED_SALMON.get())
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.STEAK_AND_POTATOES.get())
				.requires(Items.BAKED_POTATO)
				...
				.unlockedBy("has_baked_potato", InventoryChangeTrigger.TriggerInstance.hasItems(Items.BAKED_POTATO))
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.ROASTED_MUTTON_CHOPS.get())
				...
				.unlockedBy("has_mutton", InventoryChangeTrigger.TriggerInstance.hasItems(Items.COOKED_MUTTON))
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.BACON_AND_EGGS.get())
				.requires(CommonTags.FOODS_COOKED_BACON)
				.requires(CommonTags.FOODS_COOKED_BACON)
				.requires(Items.BOWL)
				.requires(CommonTags.FOODS_COOKED_EGG)
				...
				.unlockedBy("has_bacon", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.COOKED_BACON.get()))
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.ROAST_CHICKEN_BLOCK.get())
				.requires(CommonTags.CROPS_ONION)
				.requires(Tags.Items.EGGS)
				...
				.unlockedBy("has_cooked_chicken", InventoryChangeTrigger.TriggerInstance.hasItems(Items.COOKED_CHICKEN))
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.SHEPHERDS_PIE_BLOCK.get())
				.requires(Items.BAKED_POTATO)
				.requires(Tags.Items.DRINKS_MILK)
				.requires(Items.BAKED_POTATO)
				.requires(CommonTags.FOODS_COOKED_MUTTON)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.HONEY_GLAZED_HAM_BLOCK.get())
				.requires(Items.SWEET_BERRIES)
				.requires(Items.HONEY_BOTTLE)
				.requires(Items.SWEET_BERRIES)
				.requires(Items.SWEET_BERRIES)
				...
				.save(output);
		output.shapeless(RecipeCategory.FOOD, ModItems.RICE_ROLL_MEDLEY_BLOCK.get())
